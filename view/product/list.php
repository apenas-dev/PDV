...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Gerenciamento de produtos e estoque</p>
    </div>
    <a href="?p=product&a=form" class="btn btn-primary">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="fas fa-boxes me-2 text-muted"></i>Lista de Produtos</span>
        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title text-danger">
                    <i class="fas fa-triangle-exclamation me-1"></i>Excluir Produto
                </h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body py-2">
                Deseja excluir o produto
                <strong id="excluir-nome"></strong>?
                <p class="text-muted small mb-0 mt-1">Esta ação não pode ser desfeita.</p>
            </div>
